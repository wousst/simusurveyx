...
namespace SimuSurvey360.Instruments
{
    class Pole : Instrument
    {
        ...
        public Pole(InstrumentType type)
        {
            _Type = type;
        ...
        {
            _BodyModel = content.Load<Model>("Pole");
            _Part1 = _BodyModel.Bones["Cylinder01"];
            _Part2 = _BodyModel.Bones["Cylinder03"];
        ...
        public void Draw()
        {
            ...
            _BodyModel.Root.Transform = Matrix.CreateRotationX(MathHelper.ToRadians(-90)) * Matrix.CreateTranslation(0f, 6.2f, 0f) * modelRotation * modelScale * rulerRotation * worldTranslation * levelTranslation;// *_world;
