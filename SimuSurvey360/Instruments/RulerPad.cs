...
namespace SimuSurvey360.Instruments
{
    class RulerPad: Instrument
    {
        ...
        public RulerPad(InstrumentType type)
        {
            _Type = type;
        ...
        public void Load(ContentManager content, int n )
        {
            ...
            _BodyModel = content.Load<Model>(@"RulerPad");
            _Part1 = _BodyModel.Bones["Group01"];
        ...
        public void Draw()
        {
            ...
            _BodyModel.Root.Transform =  Matrix.CreateRotationX(MathHelper.ToRadians(-90)) * Matrix.CreateTranslation(0f,1f, 0f) *  modelRotation * modelScale * ObjRotation * worldTranslation * levelTranslation;// *_world;
