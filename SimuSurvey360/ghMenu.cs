...
namespace SimuSurvey360
{
    ...
    /// </summary>
    public class ghMenu : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public ghMenu(Game game)
            : base(game)
        {
            // TODO: Construct any child components here
        }

        public ghMenu(SystemState _State, Game game)
            : base(game)
        {
            State = _State;
        }
        ...
        protected void Draw_Entry(SpriteBatch sbBatch)
        {
            ...
            for ( int i = 0 ; i < Item_Ns ; i++ )
            {
                ...
                if ( _SelectedItem == i ) // Highlight
                {
                    ...
                    Btn_Index += i << 1;
                    sbBatch.Draw(ghMenuSheet.Texture, new Vector2(400, 130),
                    ...
                    sbBatch.Draw(ghMenuSheet.Texture, new Vector2(HLX, HLY),
                                   ...
                                   Color.White,
                                   0f, new Vector2(0, 0), 2.2f, SpriteEffects.None, 0);
