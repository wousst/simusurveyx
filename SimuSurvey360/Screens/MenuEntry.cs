...
namespace SimuSurvey360
{
    ...
    class MenuEntry
    {
        ...
        public event EventHandler<PlayerIndexEventArgs> Lefted;
        public event EventHandler<PlayerIndexEventArgs> Righted;
        ...
        {
            if (Lefted != null)
                Lefted(this, new PlayerIndexEventArgs(playerIndex));
        }
        /// <summary>
        ...
        {
            if (Righted != null)
                Righted(this, new PlayerIndexEventArgs(playerIndex));
        }
        #endregion
                                 ...
                                 bool isSelected, GameTime gameTime)
        {
            ...
            Color color = isSelected ? Color.Orange : Color.DarkSlateGray;
