...
namespace SimuSurvey360
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        public override void HandleInput(SystemState State, InputState input, GameTime gameTime )
        {
            ...
            if ( (State.CurrState != SystemState.S_State.STATE_MENU_MAIN) &&
        ...
        /// <summary>
        /// Handler for when the user has pressed the left key
        /// </summary>
        ...
        /// <summary>
        /// Handler for when the user has pressed the right key
        /// </summary>
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Vector2 position = new Vector2(850, 450 + _HeightOffset);
            ...
            spriteBatch.Draw(_Panel, new Vector2(800, 300),
                           new Rectangle(0, 0, _Panel.Width, _Panel.Height),
                           Color.White,
            ...
            // Draw the menu title.
            Vector2 titlePosition = new Vector2(980, 400);
            Vector2 titleOrigin = font.MeasureString(menuTitle) / 2;
            // Color titleColor = new Color(192, 192, 192, TransitionAlpha);
            Color titleColor = new Color(25, 50, 250, TransitionAlpha);
