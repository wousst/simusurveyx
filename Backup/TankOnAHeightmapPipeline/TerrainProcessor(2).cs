...
namespace TanksOnAHeightmapPipeline
{
    ...
    public class TerrainProcessor : ContentProcessor<Texture2DContent, ModelContent>
    {
        ...
        private string terrainTexture = "texture01.bmp";
                                             ...
                                             ContentProcessorContext context)
        {
            ...
            if ( input.Identity.SourceFilename.Contains( "01" ))
            TerrainTexture = "texture01.bmp";
            else if (input.Identity.SourceFilename.Contains("02"))
                TerrainTexture = "texture02.bmp";
            else if (input.Identity.SourceFilename.Contains("03"))
                TerrainTexture = "texture03.bmp";
            else if (input.Identity.SourceFilename.Contains("04"))
                TerrainTexture = "texture04.bmp";
            else if (input.Identity.SourceFilename.Contains("05"))
                TerrainTexture = "texture05.bmp";
